#ifndef _MATMUL_SKEL_H
#define _MATMUL_SKEL_H
/// @file matmul.idl
///
...
extern "C" {
#endif
_ATTRIBUTE_VISIBILITY uint32_t matmul_skel_handle_invoke_qaic_version = 10049;
_ATTRIBUTE_VISIBILITY char matmul_skel_handle_invoke_uri[77+1]="file:///libmatmul_skel.so?matmul_skel_handle_invoke&_modver=1.0&_idlver=1.0.0";
static __inline int _skel_method(int (*_pfn)(remote_handle64, const float*, int, const float*, int, float*, int, unsigned int, uint64*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   ...
   _QAIC_ASSERT(_nErr, ((_praROut[0].buf.nLen / 4)) >= (size_t)(_rout2Len[0]));
   _rout2[0] = _praROut[0].buf.pv;
   _COPY(_in3, 0, _primIn, 12, 4);
   _TRY(_nErr, _pfn(_h, (const float*)*_in0, (int)*_in0Len, (const float*)*_in1, (int)*_in1Len, (float*)*_rout2, (int)*_rout2Len, (unsigned int)*_in3, (uint64*)_rout4));
   _COPY(_primROut, 0, _rout4, 0, 8);
   _QAIC_CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_1(int (*_pfn)(remote_handle64, const float*, int, const float*, int, float*, int, unsigned int, unsigned int, unsigned int, uint64*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd = 0;
   char* _in0[1] = {0};
   uint32_t _in0Len[1] = {0};
   char* _in1[1] = {0};
   ...
   _TRY(_nErr, _pfn(_h, (const float*)*_in0, (int)*_in0Len, (const float*)*_in1, (int)*_in1Len, (float*)*_rout2, (int)*_rout2Len, (unsigned int)*_in3, (unsigned int)*_in4, (unsigned int)*_in5, (uint64*)_rout6));
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(matmul_skel_handle_invoke)(remote_handle64 _h, uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc)){
      case 0:
      return _skel_method_3(__QAIC_IMPL(matmul_open), _sc, _pra);
      case 1:
      return _skel_method_2(__QAIC_IMPL(matmul_close), _sc, _pra);
      case 2:
      return _skel_method(__QAIC_IMPL(matmul_seq), _h, _sc, _pra);
      case 3:
      return _skel_method_1(__QAIC_IMPL(matmul_static_), _h, _sc, _pra);
      case 4:
      return _skel_method_1(__QAIC_IMPL(matmul_dynamic), _h, _sc, _pra);
      case 5:
      return _skel_method(__QAIC_IMPL(matmul_hvx), _h, _sc, _pra);
      case 6:
      return _skel_method_1(__QAIC_IMPL(matmul_mt), _h, _sc, _pra);
      case 7:
      return _skel_method_1(__QAIC_IMPL(matmul_hvx_mt_static), _h, _sc, _pra);
      case 8:
      return _skel_method(__QAIC_IMPL(matmul_qhl_sdk), _h, _sc, _pra);
   }
